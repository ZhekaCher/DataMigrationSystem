...
namespace DataMigrationSystem.Models.Parsed.Avroradata
{
    ...
    public class MitworkLotDto
    {
        ...
        [Column("lot_month")] public string LotMonth { get; set; }
        [Column("lot_delivery_time")] public string LotDeliveryTime { get; set; }
        [Column("lot_sum")] public string LotSum { get; set; }
        [Column("lot_pre_pay")] public string LotPrePay { get; set; }
        ...
        public List<MitworkLotFileDto> LotDocumentations { get; set; }
    }
}